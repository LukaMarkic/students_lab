                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text('${widget.student.name} ${widget.student.surname}', style: const TextStyle(color: Colors.black87, fontSize: 18, fontWeight: FontWeight.bold),),
                              ],
                            ),
                            ...
                            Row(
                              children: [
                                const Icon(
                                  ...
                                  size: 28,),
                                const SizedBox(width: 10),
                                Text('${widget.student.birthDate.day}.${widget.student.birthDate.month}.${widget.student.birthDate.year}.', style: const TextStyle(color: Colors.black54, fontSize: 14, fontWeight: FontWeight.bold),),
                              ],
                            ),
                    ...
                    Card(
                      ...
                      child: Container(
                        ...
                        Column(
                          ...
                          children: [
                            const Text('Predna zadaća', style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold), textAlign: TextAlign.left,),
                            const Divider(height: 1,color: primaryDividerColor,),
                            const SizedBox(height: 15,),
                            const Text('Komentar: ', style: TextStyle(color: Colors.black87, fontSize: 16, fontWeight: FontWeight.bold), textAlign: TextAlign.left,),
                            Container(
                              width: constraints.maxWidth,
                              ...
                              child: Text('${widget.submittedHomework.feedback}', style: const TextStyle(color: Colors.black87, fontSize: 14, fontWeight: FontWeight.bold), textAlign: TextAlign.start,),
                            ),
                            Row(
                              children: [
                                TextButton(
                            ...
                            Text('Ranije predano: ${getTimeDifference(widget.submittedHomework.timeOfSubmit!, widget.homework.deadline)}', style: const TextStyle(color: Colors.black, fontSize: 14, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
                            const SizedBox(height: 10,),
                            Row(
                              children: [
                                const Text('Ocijena: ', style: TextStyle(color: Colors.black54),),
                                widget.submittedHomework.graded && widget.grade != null ? Text('${roundToSecondDecimal(widget.grade! * 100)} %', style: const TextStyle(color:Colors.black, fontWeight: FontWeight.w800),) : const Text('Nije ocijenjeno', style: TextStyle(color: Colors.redAccent),),
                              ],
                            )
                          ],
                        ),
                ...
                return AlertDialog(
                  ...
                  content: Column(
                    ...
                    children:[
                      ...
                      ((achievedScore ?? 0) <= (maxScore ?? 100)) ? Container(child: (maxScore != null && achievedScore != null) ? Text('${roundToSecondDecimal(achievedScore!/maxScore! * 100)} %') : const Text(''),) : const Text('Ocjena ne može premašiti maksimalnu vrijednost.'),
                      ((achievedScore ?? 0) < 0 || (maxScore ?? 100) < 0) ? const Text('Unesite pozitivne vrijednosti') : const Text(''),
                    ],
